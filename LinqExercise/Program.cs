...
namespace LinqExercise
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            numbers.SetValue(99, 4); numbers.OrderByDescending(x => x).ToList().ForEach(x => Console.WriteLine(x));
            ...
            var sumAndYOE = employees.Where(x => x.YearsOfExperience <= 10 && x.Age > 35).ToList();
            ...
            employees = employees.Append(new Employee("Jose", "Villalobos", 27, 0)).ToList();
            Console.WriteLine("------------------");
            Console.WriteLine("Employere added");
